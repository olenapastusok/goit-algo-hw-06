...
print("\n" + "="*50)
print(f"ПОРІВНЯННЯ ШЛЯХІВ: {start_node} -> {end_node}")
print("="*50)

print(f"\nШлях BFS (найкоротший):")
print(" -> ".join(bfs_path))
print(f"Кількість перегонів: {len(bfs_path) - 1}")

print(f"\nШлях DFS (перший знайдений углиб):")
print(" -> ".join(dfs_path))
print(f"Кількість перегонів: {len(dfs_path) - 1}")